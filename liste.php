...
//Reproduction
if (isset($_GET['breed']) && isset($_GET['male']) && isset($_GET['female']) && isset($_GET['offspring'])) {
    $Objserpent = new Serpent("vide");
    $offspring_count = min(max(1, intval($_GET['offspring'])), 5); // Ensure 1-5 offspring
    $breeding_result = $Objserpent->breed($_GET['male'], $_GET['female'], $offspring_count);
